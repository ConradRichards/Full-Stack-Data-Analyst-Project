...
### Executive Summary: 
The synthetic raw data set that you will see in the "Raw Data Set" File attached to this Repository was created by AI CLAUDE as well as adjusting it to be realistic for more analysis for a precise messy data set to clean in SQL including a/b testing in Python after extracting, transforming and loading the csv file from claude into excel for adjustments. Lastly bringing the data to life to showcase findings and what decision can be made to create impact and resolution to bottle neck issues and reduce churn.  
